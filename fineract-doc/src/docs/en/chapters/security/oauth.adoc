...
. Click on tab 'Users' on the left, then 'Create new user' with email `test@example.com`, First name `Mifos`, Last name `User`
...
. Click 'Configure a new mapper', and choose 'User Property'
